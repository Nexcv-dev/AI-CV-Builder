...
Timeout: 120 seconds
ZIP: apps/workers/cv-import-worker/dist/nexcv-cv-import-worker.zip
```
...
Memory: 512 MB minimum
Timeout: 90 seconds
ZIP: apps/workers/pdf-worker/dist/nexcv-pdf-worker.zip
```
...
Timeout: 60 seconds
ZIP: apps/workers/pdf-lambda/dist/nexcv-pdf-lambda.zip
...
Memory: 256 MB
Timeout: 30 seconds
ZIP: apps/workers/email-worker/dist/nexcv-email-worker.zip
```
