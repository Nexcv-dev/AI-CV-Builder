            ...
            <div className="relative overflow-hidden">
              <label
                ...
                className={`group relative flex flex-col items-center justify-center p-6 sm:p-10 rounded-2xl border-2 border-dashed transition-all duration-500 cursor-pointer ${isImporting
                  ...
                  : (isDarkMode
                    ? 'border-violet-500/70 bg-linear-to-b from-slate-800/80 via-slate-900 to-violet-950/40 hover:border-violet-400 hover:shadow-lg hover:shadow-violet-900/30'
                    : 'border-violet-300 bg-linear-to-b from-violet-50/60 via-white to-fuchsia-50/40 hover:border-violet-400 hover:from-violet-50 hover:via-white hover:to-fuchsia-50/60 hover:shadow-lg hover:shadow-violet-100/50')
                  }`}
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-linear-to-bl from-violet-100/40 to-transparent rounded-bl-full pointer-events-none" />
                <div className="absolute bottom-0 left-0 w-16 h-16 bg-linear-to-tr from-violet-100/30 to-transparent rounded-tr-full pointer-events-none" />

                <div className="relative mb-6">
                  <div className="absolute inset-0 bg-linear-to-tr from-violet-500/30 to-fuchsia-500/30 rounded-full blur-2xl scale-[2.5] group-hover:scale-[3] transition-transform duration-700 ease-out animate-pulse" />
                  <div className="absolute inset-0 bg-linear-to-br from-violet-400/40 to-violet-400/40 rounded-full blur-xl scale-150 group-hover:scale-[1.8] transition-transform duration-500" />
                  ...
                  <div className="relative flex items-center justify-center w-20 h-20 bg-white/40 backdrop-blur-md border border-white/60 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] group-hover:shadow-[0_8px_30px_rgb(99,102,241,0.2)] group-hover:bg-white/60 transition-all duration-500 group-hover:-translate-y-2 group-hover:scale-110 overflow-hidden">
                    <div className="absolute inset-0 bg-linear-to-tr from-transparent via-white/50 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-in-out" />
