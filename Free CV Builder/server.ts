...
const routeDeps = {
    ...
    createLemonSqueezyCheckout, deleteLemonSqueezyDiscount, getLemonSqueezyConfigIssues, getMissingLemonSqueezyConfigKeys, isLemonSqueezyConfigured, syncLemonSqueezyDiscount, verifyLemonSqueezySignature,
